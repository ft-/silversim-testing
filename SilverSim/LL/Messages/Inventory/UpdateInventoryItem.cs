    ...
    public class UpdateInventoryItem : Message
    {
        ...
        public static Message Decode(UDPPacket p)
        {
            ...
            for (uint i = 0; i < c; ++i)
            {
                ...
                d.BaseMask = (InventoryItem.PermissionsMask)p.ReadUInt32();
                d.OwnerMask = (InventoryItem.PermissionsMask)p.ReadUInt32();
                d.GroupMask = (InventoryItem.PermissionsMask)p.ReadUInt32();
                d.EveryoneMask = (InventoryItem.PermissionsMask)p.ReadUInt32();
                d.NextOwnerMask = (InventoryItem.PermissionsMask)p.ReadUInt32();
