...
namespace SilverSim.Scene.Types.Agent
{
    ...
    public interface IAgentTeleportServiceInterface
    {
        ...
        void DisableSimulator(UUID fromSceneID, RegionInfo regionInfo);
        void EnableSimulator(UUID fromSceneID, DestinationInfo destinationRegion);
        /** <summary>this is the remote call</summary> **/
        [Description("Remote call to other simulators")]
        void ReleaseAgent(UUID fromSceneID, RegionInfo regionInfo);
