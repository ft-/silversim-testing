...
namespace SilverSim.Scene.ServiceInterfaces.Voice
{
    public struct VoiceAccountInfo
    {
        public string AgentName;
        public string Password;
        public string SipUri;
        public string VoiceAccountApi;
    }

    public struct VoiceChannelInfo
    {
        public string ChannelSipUri;
    }

    public struct UserChannelInfo
    {
    ...
    {
        public abstract VoiceAccountInfo ProvisionAccount(UGUIWithName agent);
