...
{
    class NullGroupRolemembersInterface : GroupsServiceInterface.IGroupRolemembersInterface
    {
        public NullGroupRolemembersInterface()
        {
        ...
        public List<GroupRolemember> this[UUI requestingAgent, UGI group, UUID roleID]
        {
            get
            {
                return new List<GroupRolemember>();
            }
        }
