...
{
    public partial class MemoryGroupsService : IActiveGroupMembershipInterface
    {
        bool IActiveGroupMembershipInterface.ContainsKey(UGUI requestingAgent, UGUI principal)
        {
            GroupActiveMembership gmem;
            return ActiveMembership.TryGetValue(requestingAgent, principal, out gmem);
        }
