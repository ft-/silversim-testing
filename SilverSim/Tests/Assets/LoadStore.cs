...
{
    public class LoadStore : ITest
    {
        private static readonly ILog m_Log = LogManager.GetLogger(MethodBase.GetCurrentMethod().DeclaringType);

        public static UUID Asset1ID = new UUID("11223344-0001-0001-0001-000000000001");
        public static UUID Asset2ID = new UUID("11223344-0001-0001-0001-000000000002");
        ...
        public bool Run()
        {
            ...
            if (asset.Temporary)
            {
                m_Log.ErrorFormat("Asset could not be retrieved correctly (Temporary {0} / {1})", asset.Temporary, false);
                return false;
            }
            ...
            if (asset.Flags != AssetFlags.Maptile)
            {
                m_Log.ErrorFormat("Asset could not be retrieved correctly (Flags {0} / {1})", (uint)asset.Flags, (uint)AssetFlags.Maptile);
                return false;
            }
            #endregion
