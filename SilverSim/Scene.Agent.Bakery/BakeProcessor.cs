    ...
    public class BakeProcessor : IBakeTextureInputCache, IDisposable
    {
        ...
        public BakeOutput Process(BakeCache cache, AssetServiceInterface assetSource, Action<string> logOutput = null)
        {
            ...
            try
            {
                ...
                DrawSubBakers(Tgt, SourceBakers[WearableType.Undershirt].OrderBy(item => item.Ordinal), ClothingIndices);
                ...
                DrawSubBakers(Tgt, SourceBakers[WearableType.Pants].OrderBy(item => item.Ordinal), ClothingIndices);
                DrawBumpMaps(Tgt, SourceBakers[WearableType.Pants], ClothingIndices);
                DrawSubBakers(Tgt, SourceBakers[WearableType.Shirt].OrderBy(item => item.Ordinal), ClothingIndices);
                DrawBumpMaps(Tgt, SourceBakers[WearableType.Shirt], ClothingIndices);
