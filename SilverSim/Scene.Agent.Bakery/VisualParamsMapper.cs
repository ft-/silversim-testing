...
namespace SilverSim.Scene.Agent.Bakery
{
    internal static class VisualParamsMapper
    {
        ...
        private static readonly VisualParamMap[] m_VisualParamMapping = new VisualParamMap[]
        {
            ...
            new VisualParamMap(26, 0, 0, 0.7),
            new VisualParamMap(27, -1.3f, -1.3f, 1.2f),
            new VisualParamMap(28, 0, 0, 2),
            new VisualParamMap(29, -0.7, -0.7, 1.3),
            new VisualParamMap(30, -0.7, -0.7, 1.3),
            new VisualParamMap(31, 0.5f, 0f, 2f, new uint[] { 872 }),
            new VisualParamMap(32, 0, 0, 1),
            ...
            new VisualParamMap(40, 0f, 0f, 1f),
            new VisualParamMap(41, 0, 0, 1),
            ...
            new VisualParamMap(100, 0, 0, 1),
            new VisualParamMap(104, 0, 0, 1),
            new VisualParamMap(105, 0.5f, 0f, 1f, new uint[] { 843, 627, 626 }),
            new VisualParamMap(106, 0, 0, 1.4),
            new VisualParamMap(107, 0, 0, 1.4),
            ...
            new VisualParamMap(144, 0, 0, 1),
            new VisualParamMap(145, 0, 0, 5),
            new VisualParamMap(146, 0, 0, 1),
            new VisualParamMap(147, 0, 0, 2),
            new VisualParamMap(148, 0, 0, 1),
            new VisualParamMap(149, 0, 0, 2),
            new VisualParamMap(150, 0f, 0f, 1f, new uint[] { 125, 126, 160, 161, 874, 878 }),
            new VisualParamMap(151, 0, 0, 1),
            new VisualParamMap(152, 0, 0, 1.5),
            new VisualParamMap(153, 0, 0, 1),
            new VisualParamMap(155, 0f, -0.9f, 1.3f, new uint[] { 29, 30 }),
            new VisualParamMap(156, 0, 0, 1),
            ...
            new VisualParamMap(172, 0, 0, 1),
            new VisualParamMap(173, 0, 0, 1),
            new VisualParamMap(174, 0, 0, 1),
            new VisualParamMap(175, 0, 0, 3),
            new VisualParamMap(176, 0, 0, 1),
            new VisualParamMap(177, 0f, 0f, 1f),
            new VisualParamMap(178, 0, 0, 1),
            new VisualParamMap(179, 0, 0, 1),
            new VisualParamMap(180, 0, 0, 1.3),
            ...
            new VisualParamMap(186, -1.3, -1.3, 1),
            new VisualParamMap(187, -0.5, -0.5, 1),
            new VisualParamMap(188, 0, 0, 0.7),
            new VisualParamMap(189, 0, 0, 1),
            new VisualParamMap(190, 0, 0, 1),
            new VisualParamMap(191, 0, 0, 1),
            new VisualParamMap(192, 0f, 0f, 1f),
            new VisualParamMap(193, 0.5f, 0f, 1f, new uint[] { 188, 642, 189, 643 }),
            new VisualParamMap(194, -2, -2, 2),
            new VisualParamMap(195, -1, -1, 1),
            new VisualParamMap(196, 0f, -2f, 1f, new uint[] { 194, 195 }),
            new VisualParamMap(197, 0, 0, 1),
