...
{
    public sealed class UpdateSettingsAgentInventory : UploadAssetAbstractCapability
    {
        ...
        public override string CapabilityName => "UpdateSettingsAgentInventory";

        public override int ActiveUploads => m_Transactions.Count;

        public UpdateSettingsAgentInventory(
            ViewerAgent agent,
