...
{
    public sealed class UpdateSettingsTaskInventory : UploadAssetAbstractCapability
    {
        ...
        public override string CapabilityName => "UpdateSettingsTaskInventory";

        public override int ActiveUploads => m_Transactions.Count;

        public UpdateSettingsTaskInventory(ViewerAgent agent, SceneInterface scene, string serverURI, string remoteip)
        ...
        public override Map UploadedData(UUID transactionID, AssetData data)
        {
            ...
            if (m_Transactions.RemoveIf(transactionID, (TransactionInfo v) => true, out kvp))
            {
                ...
                {
                    throw new UploadErrorException(this.GetLanguageString(m_Agent.CurrentCulture, "NotAllowedToModifySettings", "Not allowed to modify settings"));
                }
        ...
        protected override AssetType NewAssetType => AssetType.Settings;
    }
}
