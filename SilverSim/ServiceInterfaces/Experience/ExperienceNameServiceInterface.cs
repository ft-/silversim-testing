...
{
    public abstract class ExperienceNameServiceInterface
    {
        public UEI this[UUID experienceID]
        {
            get
            {
                UEI uei;
                if (!TryGetValue(experienceID, out uei))
                {
        ...
        public abstract void Store(UEI experience);

        public void Store(ExperienceInfo experience)
        {
            Store(experience.ID);
        }
    }
