...
namespace SilverSim.Types.Sensor
{
    public static class SensorMethods
    {
        ...
        public static double DirectionToCosine(this Vector3 direction, Quaternion sensorRotation)
        {
            ...
            try
            {
                cosine = bodyVec.X / bodyVec.Length;
            }
            catch
            {
                cosine = 0;
        ...
        public static double DirectionToSensorArc(this Vector3 direction, Quaternion sensorRotation)
            => Math.Acos(direction.DirectionToCosine(sensorRotation));

        public static double SensorArcToCosine(this double sensorArc) => Math.Cos(sensorArc);
    }
}
