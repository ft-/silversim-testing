...
namespace SilverSim.HttpClient
{
    ...
    public static class HttpRequestHandler
    {
        ...
        /**********************************************************************/
        /* asynchronous calls */
        public static void DoAsyncGetRequest(string url, IDictionary<string, string> getValues, HttpResponseHandler asyncHandler, int timeoutms)
        {
            DoAsyncRequest("GET", url, getValues, string.Empty, string.Empty, false, asyncHandler, timeoutms);
        }

        /*---------------------------------------------------------------------*/
        public static void DoAsyncHeadRequest(string url, IDictionary<string, string> getvalues, HttpResponseHandler asyncHandler, int timeoutms)
        {
            DoAsyncRequest("HEAD", url, getvalues, string.Empty, string.Empty, false, asyncHandler, timeoutms);
        }

        /*---------------------------------------------------------------------*/
        public static void DoAsyncPostRequest(string url, IDictionary<string, string> getValues, IDictionary<string, string> postValues, bool compressed, HttpResponseHandler asyncHandler, int timeoutms)
        {
            string post = BuildQueryString(postValues);
            DoAsyncRequest("POST", url, getValues, "application/x-www-form-urlencoded", post, compressed, asyncHandler, timeoutms);
        }

        /*---------------------------------------------------------------------*/
        public static void DoAsyncRequest(string method, string url, IDictionary<string, string> getValues, string content_type, string post, bool compressed, HttpResponseHandler asyncHandler, int timeoutms)
        {
            if (getValues != null)
            {
                url += "?" + BuildQueryString(getValues);
                    ...
                    request.BeginGetResponse(delegate(IAsyncResult ar)
                    {
                        try
                        {
                            using (WebResponse response = request.EndGetResponse(ar))
                            {
                                ...
                                {
                                    asyncHandler.OnData(responseStream);
                                }
                            }
                        }
                        catch (Exception e)
                        {
                            asyncHandler.OnException(e);
                        }
                    }, null);
                }
                catch (Exception e)
        ...
        /*---------------------------------------------------------------------*/
        public static void DoAsyncRequest(string method, string url, IDictionary<string, string> getValues, string content_type, int content_length, StreamPostDelegate postdelegate, bool compressed, HttpResponseHandler asyncHandler, int timeoutms)
        {
            if (getValues != null)
            {
                url += "?" + BuildQueryString(getValues);
